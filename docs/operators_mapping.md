...
* **RAF capture** – exercises the full ingestion pipeline, from RAF parsing to
  ...
  `src/tnfr_lfs/resources/data/test1.raf` fixture from your local checkout (or a
  personal capture) with [`tnfr_lfs baseline`](cli.md#baseline) to regenerate the
  JSONL bundle referenced throughout this document—no binary assets are copied
  into the published docs.【F:docs/cli.md†L7-L68】
