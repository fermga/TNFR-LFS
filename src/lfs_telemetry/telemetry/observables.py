...
def car_spec_for(car_name: str | None) -> CarSpec:
    ...
    known = set(CarSpec.__dataclass_fields__)
...
def _asset_search_dirs(env_var: str, *subpath: str) -> list[Path]:
    ...
    Thin wrapper around :func:`lfs_telemetry.app_paths.candidate_asset_dirs`.
    """
    from ..app_paths import candidate_asset_dirs
    return candidate_asset_dirs(*subpath, env_var=env_var)
