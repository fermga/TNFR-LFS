...
- **Ventilación / fade de freno** – utiliza directamente las temperaturas de pinza/disco que publica OutGauge cuando están disponibles; si el broadcaster entrega el marcador (`0 °C`) el fusionador recurre al proxy térmico para mantener una serie finita antes de alimentar los indicadores de fade.【F:tnfr_lfs/acquisition/fusion.py†L248-L321】【F:tnfr_lfs/core/metrics.py†L860-L982】
