...
class TelemetryRecord:
    ...
    clutch_input: float = 0.0
    handbrake_input: float = 0.0
    steer_input: float = 0.0
    wheel_load_fl: float = 0.0
    wheel_load_fr: float = 0.0
    wheel_load_rl: float = 0.0
    wheel_load_rr: float = 0.0
    wheel_lateral_force_fl: float = 0.0
    wheel_lateral_force_fr: float = 0.0
    wheel_lateral_force_rl: float = 0.0
    wheel_lateral_force_rr: float = 0.0
    wheel_longitudinal_force_fl: float = 0.0
    wheel_longitudinal_force_fr: float = 0.0
    wheel_longitudinal_force_rl: float = 0.0
    wheel_longitudinal_force_rr: float = 0.0
    suspension_deflection_fl: float = 0.0
    suspension_deflection_fr: float = 0.0
    suspension_deflection_rl: float = 0.0
    suspension_deflection_rr: float = 0.0
